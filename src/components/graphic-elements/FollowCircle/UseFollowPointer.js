...
export function useFollowPointer(ref) {
    ...
    useEffect(() => {
      ...
      const handlePointerMove = ({ clientX, clientY }) => {
        ...
        console.log('y, parent top, circle offsetHeight', clientY, circle.offsetTop, element.offsetHeight/2)
        console.log('small relative to big', clientY - circle.offsetTop - element.offsetHeight / 2)
        console.log('bottom of big', circle.offsetHeight - element.offsetHeight)
